        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            if (globalVeriAktarimi.Yetki == "Yönetici")
            {
                ...
                TurSorgu();
                    ...
                    YazilariBuyut();
                    string sorgu = "UPDATE tblKitap SET KitapAd='" + textBox2.Text + "', YazarNo="+YazarNum + ", Yayinevi='" + textBox4.Text + "', Barkod='"+textBox5.Text+"', TurNo="+TurNum+", SayfaSayisi='"+textBox7.Text+"', AdetSayisi="+numericUpDown1.Value+" WHERE KitapNo="+ textBox1.Text+"";
                    kitapClss.kitapSorgu(sorgu);
