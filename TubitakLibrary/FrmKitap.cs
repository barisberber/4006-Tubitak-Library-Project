...
namespace Tubitak
{
    public partial class FrmKitap : Form
    {
        ...
        {
            string sorgu = "SELECT tblKitap.KitapNo,tblKitap.KitapAd,tblYazar.YazarAd,tblKitap.Yayinevi,tblTur.TurAd,tblKitap.SayfaSayisi,tblKitap.AdetSayisi from (tblKitap inner join tblYazar on tblKitap.YazarNo=tblYazar.YazarNo) inner join tblTur on tblKitap.TurNo=tblTur.TurNo order by tblKitap.KitapNo asc";
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked && comboBox1.SelectedIndex == 0)
                sorgu = "select tblKitap.KitapNo,tblKitap.KitapAd,tblYazar.YazarAd,tblKitap.Yayinevi,tblTur.TurAd,tblKitap.SayfaSayisi,tblKitap.AdetSayisi from (tblKitap inner join tblYazar on tblKitap.YazarNo=tblYazar.YazarNo) inner join tblTur on tblKitap.TurNo=tblTur.TurNo WHERE tblKitap.KitapAd LIKE '%" + textBox1.Text + "%' order by tblKitap.KitapNo asc";
            else if (radioButton3.Checked && comboBox1.SelectedIndex == 1)
                sorgu = "select tblKitap.KitapNo,tblKitap.KitapAd,tblYazar.YazarAd,tblKitap.Yayinevi,tblTur.TurAd,tblKitap.SayfaSayisi,tblKitap.AdetSayisi from (tblKitap inner join tblYazar on tblKitap.YazarNo=tblYazar.YazarNo) inner join tblTur on tblKitap.TurNo=tblTur.TurNo WHERE tblYazar.YazarAd LIKE '%" + textBox1.Text + "%' order by tblKitap.KitapNo asc";
        ...
        {
            globalVeriAktarimi.Numara = Convert.ToInt16(dataGridView1.CurrentRow.Cells[0].Value);
